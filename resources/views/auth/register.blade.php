    ...
    <div class="row justify-content-center">
        <div class="col-md-8 text-center">
          <div class="card mx-auto" style="width: 28rem;">
              ...
              <p class="text-muted">登録して友達の洋服をチェックしよう</p>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('フルネーム') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="username" class="col-md-4 col-form-label text-md-end">ユーザーネーム</label>
